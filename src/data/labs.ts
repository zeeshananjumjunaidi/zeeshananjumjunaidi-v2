...
export const labs: Lab[] = [
  ...
  },
  {
    ...
    writeup: [
      ...
      "It currently covers traffic, storage, cache, bandwidth, compute, and database sharding, plus a diagram tool for sketching the architecture itself: drag on labeled Database, User, Cache, Server, Gateway, Queue, or CDN icons (or a plain box, container, or freestanding text), connect them, pick a shape, group and color them, animate the data flow between them. More calculator sections (queue, availability, cost, and the rest) get added a couple at a time.",
